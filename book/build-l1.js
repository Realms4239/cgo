...
P('Les 153 runs sont horodatés par leur identifiant même : run-1788191429 commence par un horodatage Unix. La machine du banc : machine virtuelle Ubuntu, deux processeurs virtuels, et chaque événement porte sa colonne d\'utilisation processeur, zéro pour cent sur les six événements du run final : la machine n\'a pas influé. Réinstaller le banc et relancer la même campagne redonnerait des conditions identiques, c\'est l\'objet du banc.');
