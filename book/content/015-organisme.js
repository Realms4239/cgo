...
module.exports = [
  { h1: `PARTIE I : PRÉSENTATION DE L'ORGANISME D'ACCUEIL ET DÉROULEMENT DU STAGE` },

  { p: `Cette première partie situe le cadre institutionnel dans lequel ce travail a été mené. Elle présente d'abord l'organisme d'accueil, la Direction Générale de la Météorologie (Météo Madagascar), à travers sa fiche d'identification, son histoire, ses missions, ses activités, son organisation et son patrimoine. Elle décrit ensuite le déroulement du stage : l'arrivée et l'accueil au sein de la structure, l'intégration dans l'équipe, l'environnement de travail et les missions confiées, puis les apports du stage et son articulation avec la problématique du mémoire.` },
